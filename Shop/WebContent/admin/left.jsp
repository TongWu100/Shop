...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('0104','01','商品管理');
		d.add('010401','0104','商品管理','${pageContext.request.contextPath}/admin?method=findAllProducts','','mainFrame');
		d.add('0105','01','订单管理');
		d.add('010501','0105','订单管理','${pageContext.request.contextPath}/admin?method=findAllOrders','','mainFrame');
		//d.add('010502','0105','订单更新','${pageContext.request.contextPath}/admin/order/list.jsp','','mainFrame');
		document.write(d);
