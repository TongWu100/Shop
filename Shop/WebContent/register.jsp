	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="registForm" class="form-horizontal" style="margin-top: 5px;" action="${pageContext.request.contextPath }/register"method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<img onclick="checkImg(this)" src="${pageContext.request.contextPath}/checkImg" />
						</div>

					</div>
					<div style="margin-left:170px;color:red">
					     ${registinfo==null?"":registinfo }
					    <%-- <c:if test="${registinfo==null }"></c:if>
					     <c:if test="${registinfo!=null}">${registinfo}</c:if> --%>
					</div>
